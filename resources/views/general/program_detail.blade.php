...
<div class="w-full p-6 mx-auto">
    <div class="flex flex-wrap -mx-3">
        ...
        <div class="flex-none w-full max-w-full px-3 mt-6">
            <div class="relative flex flex-col min-w-0 mb-6 h-full break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                        ...
                        <div class="mb-4">
                            ...
                            <p>
                                ...
                                <div class="mb-4">
                                    ...
                                    <a href="{{asset('/storage/'.$program->guidebook)}}" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"><i class="far fa-file-pdf pr-2"></i>guidebook.pdf</a>
                                </div>
                            </div>
