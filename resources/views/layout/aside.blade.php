    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-screen grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full">
                <a href="{{route('user.profile.edit', Auth::user()->profileUser->uuid)}}" class="{{isActiveRoute('user.profile')}} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="../pages/tables.html">
            ...
            <li class="mt-0.5 w-full">
                <a href="{{route('user.applicant.index')}}" class="{{isActiveRoute('user.applicant')}}  py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="../pages/virtual-reality.html">
                    <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Lamaran Saya</span>
                </a>
            </li>
            @endif
            ...
            <li class="mt-0.5 w-full">
                <a href="{{route('mitra.profile.edit', Auth::user()->profileMitra->uuid)}}" class="{{isActiveRoute('mitra.profile')}} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="../pages/tables.html">
                    <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2Z"></path>
                            <path d="M8 14H16L18 20H6L8 14Z"></path>
            ...
            <li class="mt-0.5 w-full">
                <a href="{{route('mitra.program.index')}}" class="{{isActiveRoute('mitra.program')}} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="../pages/virtual-reality.html">
                    <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>box-3d-50</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Program Dashboard</span>
                </a>
            </li>
            @endif
            ...
            <li class="mt-0.5 w-full">
                <a href="{{route('admin.category.index')}}" class="{{isActiveRoute('admin.category')}} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="../pages/billing.html">
            ...
            <li class="mt-0.5 w-full">
                <a href="{{route('admin.slider.index')}}" class="{{isActiveRoute('admin.slider')}} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="../pages/billing.html">
                    <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="12px" height="12px" viewBox="0 0 24 24" version="1.1">
                            <title>slider</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                              <path d="M0,0 L0,24 L24,24 L24,0 L0,0 Z M4,16 L20,16 L20,14 L4,14 L4,16 Z M8,10 L20,10 L20,8 L8,8 L8,10 Z M12,4 L20,4 L20,2 L12,2 L12,4 Z" fill="#000000"></path>
                            </g>
                          </svg>
            ...
            <li class="mt-0.5 w-full">
                <a href="{{route('admin.mitra.index')}}" class="{{isActiveRoute('admin.mitra')}} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="../pages/billing.html">
                    <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0z" fill="none"/>
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h8c1.1 0 2-.9 2-2V4a2 2 0 0 0-2-2zm0 2v2H6V4h8zm-1 2H7v11h6V6zm5 3h2v11h-2V9zm-4 7h2v2h-2v-2zm-4 0h2v2h-2v-2zm-4 0h2v2H6v-2z"/>
                          </svg>
                    </div>
            ...
            <li class="mt-0.5 w-full">
                <a href="{{route('program')}}" class="{{isActiveRoute('program')}} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="../pages/rtl.html">
                    <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#000000" width="12px" height="12px">
                            <path d="M0 0h24v24H0z" fill="none"/>
                            <path d="M12 2C6.48 2 2 6.48 2 12c0 1.97.58 3.81 1.57 5.35l-1.43 1.43L3.57 19h2.82l1.43-1.43C8.19 17.42 10.03 18 12 18c5.52 0 10-4.48 10-10S17.52 2 12 2zm-1 13h-2v-2h2v2zm4 0h-2v-2h2v2zm0-4h-2V7h2v4z"/>
                        </svg>
            ...
            <li class="w-full my-4">
                <h6 class="pl-5 ml-4 font-bold border w-11/12 leading-tight uppercase text-xs opacity-60"></h6>
            </li>
